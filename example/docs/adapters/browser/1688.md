...
- This adapter only returns fields visible on public pages. It does not send inquiries, place orders, or access seller
  back office data.
...
- If `opencli 1688 item` reports `did not expose product context`, first make sure the open page is a real
  `detail.1688.com` item page.
