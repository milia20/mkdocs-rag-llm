...
Build a comprehensive test suite using V2EX (https://v2ex.com/) as the single target website to iteratively improve
OpenCLI Operate's reliability and Claude Code skill effectiveness. Run 10 rounds of AutoResearch iteration (5
code-level + 5 SKILL.md-level).
